            ...
            <div className="info">
              {title && (
                <p
                  ...
                  style={{
                    color: title_color,
                    fontWeight: font_weight_title_card,
                    fontStyle: font_type_title_card,
                    fontSize: font_size_title_card,
                  }}
                >
        ...
        {para && (
          <p
            ...
            style={{
              ...
              fontWeight: font_weight_desc_card,
              fontStyle: font_type_desc_card,
              fontSize: font_size_desc_card,
            }}
          >
            {useFormattedText(para)}
          </p>
        )}
      </div>
    ) : null
